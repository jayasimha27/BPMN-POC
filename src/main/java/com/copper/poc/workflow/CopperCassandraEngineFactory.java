 ...
 * @author jaja0617
 */
public class CopperCassandraEngineFactory extends org.copperengine.core.persistent.cassandra.CassandraEngineFactory<PojoDependencyInjector> {
    ...
    public CopperCassandraEngineFactory() {
