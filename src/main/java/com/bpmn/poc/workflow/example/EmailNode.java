...
import static com.bpmn.poc.workflow.example.EmailNode.IN_NAME;
import static com.bpmn.poc.workflow.example.EmailNode.OUT_MESSAGE;
...
public class EmailNode implements ActionBlock, Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = LoggerFactory.getLogger(EmailNode.class);
    ...
    public int execute(FlowContext ctx) throws FlowExecutionException {
        ...
        String message = "Sent Test mail Sucessfully !";
        if (name != null) {
            message += name;
        }
